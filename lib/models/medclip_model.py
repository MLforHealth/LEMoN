...
class MedCLIPModel(nn.Module):
    def __init__(self,
        ...
        self.text_model = MedCLIPTextModel(bert_type=bert_type, proj_bias=False)
...
class CLIPBinaryClassifier(nn.Module):
    """ takes MedCLIP model (text and image) for supervised classification on images.
    """
    def __init__(self, medclip_base, input_dim=1024, output_dim=1):
        super(CLIPBinaryClassifier, self).__init__()
        self.medclip_base = medclip_base
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        img_embeds = self.medclip_base.encode_image(pixel_values)
        text_embeds = self.medclip_base.encode_text(text_input_ids, attention_mask)
